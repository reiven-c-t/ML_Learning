...
if __name__ == '__main__':
    from PythonMachineLearning.Chapter12.load_data import load_mnist

    X_train, y_train = load_mnist("/Users/reiven/Documents/Python/ML_Learning/PythonMachineLearning/Chapter12/mnist",
                                  kind='train')
    print(X_train.shape)
    ...
    import pickle
    #
    # pickle.dump(nn, open("nn.pkl", "wb"), protocol=4)
    nn = pickle.load(open("nn.pkl", "rb"))
    y_train_pred = nn.predict(X_train)
    acc = np.sum(y_train == y_train_pred, axis=0) / X_train.shape[0]
    print("Training acuracy: %.2f%%" % acc * 100)
